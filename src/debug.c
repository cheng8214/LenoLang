...
static const char* opCodeNames[] = {
    ...
    "OP_EQ", "OP_NEQ", "OP_IS_NULL", "OP_LT", "OP_GT", "OP_LE", "OP_GE", "OP_IN", "OP_RANGE",
    "OP_JUMP", "OP_JUMP_IF_FALSE", "OP_JUMP_IF_TRUE", "OP_LOOP",
    "OP_CALL", "OP_TAIL_CALL", "OP_CLOSURE", "OP_RETURN", "OP_RETURN_MULTI",
...
int disassembleInstruction(Chunk* chunk, int offset) {
    ...
    switch (instruction) {
        ...
        case OP_STRUCT_INIT: {
            ...
            // + 模块限定操作数 (mod_space 1字节 + mod_slot 2字节，S2/2b-2)
            return offset + 8 + generic_count * 2 + arg_count;
        }
        case OP_GET_FIELD:
        case OP_SET_FIELD: {
