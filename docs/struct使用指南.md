...
main() {
    ...
    Point p1 = new math.Point(x = 10, y = 20)
    print(p1.test())  // 调用 struct 方法
    
    // 函数参数使用导入的类型
    Point p2 = new math.Point(x = 5, y = 8)
...
main() {
    var rect = new shapes.Rectangle(width = 5.0, height = 3.0)
    var circle = new shapes.Circle(radius = 2.0)
...
main() {
    ...
    var circle = new geo.Circle(radius = 2.0)
