...
Point p = pt.Point()  // 现在可以直接使用 Point 类型
```
...
```leno
// module.leno
var public_var = 42           // ✅ 导出
var _private_var = 100        // ❌ 不导出
...
main() {
    ...
    // Circle c = shape.Circle()  // 错误：Circle 未定义
